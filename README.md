...
- `!id` (enregistrer/afficher tes IDs Steam/Epic/CoC/Brawl + tag clan CoC)
...
- `!stats cocclan [#TAG]` (infos clan Clash of Clans; si tag absent, utilise `!id cocclan` ou déduit le clan depuis `!id coc`)
